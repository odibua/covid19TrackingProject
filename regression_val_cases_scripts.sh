...
regression_type_array="multilinear multilinear_ridge multilinear_lasso"
...
#python managers.py --mode perform_deaths_multilinear_regression --state california --county alameda imperial riverside sacramento sanfrancisco sonoma --validate_state_name california --validate_county_names sanfrancisco --ethnicity_list Black White Asian Hispanic --reg_key discrepancy
#python managers.py --mode perform_deaths_multilinear_regression --state california --county alameda imperial sanfrancisco santaclara --validate_state_name california --validate_county_names losangeles sacramento --ethnicity_list Black White Asian Hispanic --reg_key discrepancy
#python managers.py --mode perform_deaths_multilinear_regression --state california --validate_state_name california --validate_county_names losangeles sacramento --ethnicity_list Black White Asian Hispanic --reg_key discrepancy
