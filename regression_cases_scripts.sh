...
python managers.py --mode perform_cases_multilinear_regression --state california --ethnicity_list Black White Asian Hispanic --reg_key mortality_rate
...
#python managers.py --mode perform_cases_multilinear_regression --all_counties_bool --state california --ethnicity_list Black White Asian Hispanic --reg_key discrepancy --regression_type rf_reg
#python managers.py --mode perform_cases_multilinear_regression --all_counties_bool --state california --ethnicity_list Black White Asian Hispanic --reg_key mortality_rate --regression_type rf_reg
#python managers.py --mode perform_cases_multilinear_regression --all_counties_bool --state california --ethnicity_list Black White Asian Hispanic --reg_key detrended_mortality_rate --regression_type rf_reg
...
##python managers.py --mode perform_cases_multilinear_regression --state california --county alameda losangeles sacramento sanfrancisco riverside sonoma santaclara --ethnicity_list Black White Asian Hispanic --reg_key discrepancy --regression_type rf_reg
#python managers.py --mode perform_cases_multilinear_regression --state california  --ethnicity_list Black White Asian Hispanic --reg_key mortality_rate --regression_type rf_reg
#python managers.py --mode perform_cases_multilinear_regression --state california --county alameda losangeles sacramento sanfrancisco riverside sonoma santaclara --ethnicity_list Black White Asian Hispanic --reg_key detrended_mortality_rate --regression_type rf_reg